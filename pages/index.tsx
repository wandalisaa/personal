      ...
      <Layout pageTitle="Home Page">
        <Row className="aboutMe">
          <div className="col-lg-6 col-sm-12">
            <h5 className="w-75">
              My name is <b>Wanda Khalishah</b> , a technology Information
              student . I live in Medan, North Sumatra, Indonesia. I am a person
              who likes to learn new things especially about{" "}
